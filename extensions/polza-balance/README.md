...
Open **Settings → Extensions** in Hermes WebUI, find **Polza.ai Balance** in the gallery, click **Install**. Refresh the page.
...
```bash
cp -r extensions/polza-balance/ /path/to/your/extensions/polza-balance/
```
...
├── polza-balance.css      ← companion styles
